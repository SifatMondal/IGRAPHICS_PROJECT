...
// Game States:
enum GameState { MENU, HELP, GAME,PRACTICE };
int currentState = MENU;
int menuSelection = 0; //  0=Start Match, 1=Practice Match, 2=Help, 3=Exit
    ...
    iFilledRectangle(445,325,150,28);
     iFilledRectangle(445,285,150,28);
       ...
       iSetColor(255, 255, 0);
        ...
        if(menuSelection == 0) iSetColor(255, 0, 0); else iSetColor(255, 255, 255);
iText(450, 370, "Start Match", GLUT_BITMAP_HELVETICA_18);

if(menuSelection == 1) iSetColor(255, 0, 0); else iSetColor(255, 255, 255);
iText(450, 330, "Practice Match", GLUT_BITMAP_HELVETICA_18);

if(menuSelection == 2) iSetColor(255, 0, 0); else iSetColor(255, 255, 255);
iText(450, 290, "Help", GLUT_BITMAP_HELVETICA_18);
...
if(currentState == MENU) {
        if(key == '\r') { // ENTER pressed
            ...
            if(menuSelection == 0) currentState = GAME;
if(menuSelection == 1) {currentState = PRACTICE;
head_x2 = 800;
head_y2 = 100;
leg_top2 = 30;
leg_bottom2 = 0;
